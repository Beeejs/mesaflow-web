// IMPLEMENTACIÓN ANTERIOR CON CSRF EN MEMORIA
// import api, { clearCsrfToken } from './axiosConfig'
...
export const login = async (loginData) => {
   ...
   *
   * Se limpiaba el CSRF guardado en memoria.
   * Ya no es necesario porque axiosConfig solicita
   * un token CSRF actualizado antes de cada
